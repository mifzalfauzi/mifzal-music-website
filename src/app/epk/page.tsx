...
export default function EPK() {
  ...
  const confirmSubmit = async () => {
    ...
    setValidationError('');
    try {
      const response = await fetch('/api/epk-contact', {
        method: 'POST',
        headers: {
