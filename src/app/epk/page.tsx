...
export default function EPK() {
  return (
    <div className="min-h-screen bg-background">
      {/* Hero/Header */}
      <section className="py-16 px-4 text-center border-border">
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto max-w-3xl">
          ...
          <p className="text-lg leading-relaxed text-muted-foreground">
            Mifzal is an emerging guitarist and composer from Malaysia, crafting cinematic progressive music that blends atmospheric textures with melodic guitar-driven compositions. His work explores the intersection of ambient soundscapes and intricate progressive arrangements, creating immersive musical narratives.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto max-w-3xl">
          <h2 className="text-2xl font-light mb-8 tracking-wider">FEATURED TRACK</h2>
      ...
      <section className="py-16 px-4 ">
        <div className="container mx-auto max-w-3xl">
          <h2 className="text-2xl font-light mb-8 tracking-wider">EXTENDED CONCEPT (OPTIONAL LISTENING)</h2>
          <div className="bg-card p-6 border border-border">
